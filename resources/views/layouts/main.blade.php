        ...
        <div class="container">
            <div class="row">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        <li><a class="{{ route_name() == 'dashboard' ? 'active' : '' }}" href="{{ route('dashboard') }}"><i class="notika-icon notika-house"></i> Beranda</a>
                        </li>
                        ...
                        <li><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i> Data Siswa</a>
                        </li>
